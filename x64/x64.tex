...
\item
\IFRU{Сишный \Tint остается 32-битным для совместимости. Все указатели теперь 64-битные.}
{C \Tint type is still 32-bit for compatibility. All pointers are 64-bit now.}
